package com.appliancesales.config;
...
import com.appliancesales.controller.RegisterController;
import com.appliancesales.controller.TestController;
import com.appliancesales.service.UserServiceImpl;
import com.appliancesales.util.MybatisRedisCache;
...
@ComponentScan(basePackageClasses={MyMvcConfig.class,RegisterController.class,
		UserServiceImpl.class,MybatisRedisCache.class})
@PropertySource("classpath:db.properties")//配置文件
@MapperScan(basePackages="com.appliancesales.dao") //扫描接口
public class MyMvcConfig extends WebMvcConfigurerAdapter{
	  ...
	  public SqlSessionFactoryBean sqlSessionFactory(DruidDataSource dataSource) throws IOException{
	      ...
	      b.setMapperLocations(applicationContext.getResources
	    		  ("classpath:com/appliancesales/dao/*.xml"));
		  return b;
	  }
	  /**
	   * 以下三个Bean配置视图解析器
...
//	}
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry){
		registry.addResourceHandler("font-awesome/**").addResourceLocations("classpath:/font-awesome/");
